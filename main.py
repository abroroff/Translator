...
# 1. BOTNI SOZLASH
# Tokenni qo'shtirnoq ichiga yozish shart!
TOKEN = "8656489669:AAEVMRvyP3A0O8vDbfSdD-PPjXk8RyUifZc"
bot = telebot.TeleBot(TOKEN)

# Render uchun kichik Web Server (Bepul reja o'chib qolmasligi uchun)
app = Flask('')
...
def run():
    # Render avtomatik PORT beradi, agar bo'lmasa 10000 ishlatiladi
...
if __name__ == "__main__":
    keep_alive() # Web serverni alohida oqimda ishga tushirish
